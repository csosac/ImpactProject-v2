...
class DForumExtension extends \Twig_Extension
{
    ...
    {
        $posts = $this->em->getRepository('ImpactBundle:Post')->findBy(
            array('poster' => $poster),
            array('date' => 'DESC'),
            $limit,
            null);
    ...
    {
        $topics = $this->em->getRepository('ImpactBundle:Topic')->findBy(
            array('user' => $poster),
            array('date' => 'DESC'),
            $limit,
            null);
    ...
    public function dfLastPostsEdited($limit = null)
    {
        ...
        $posts = $this->em->getRepository('ImpactBundle:Post')->findLastEdited($limit);
    ...
    {
        $topic = $this->em->getRepository('ImpactBundle:Topic')->findOneBy(
